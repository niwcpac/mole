...
class ScriptCondition(models.Model):
    ...
    event_metadata_contains = models.CharField(max_length=100, blank=True, null=True, unique=False)
    event_metadata_excludes = models.CharField(max_length=100, blank=True, null=True, unique=False)
    trigger_metadata_contains = models.CharField(max_length=100, blank=True, null=True, unique=False)
    trigger_metadata_excludes = models.CharField(max_length=100, blank=True, null=True, unique=False)
