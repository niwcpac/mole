...
def db(
    backup: bool = typer.Option(False, "-b", "--backup", help="backup the database hosted in the postgres container"),
    load: Optional[List[str]] = typer.Option(None, "-l", "--load", metavar="LOAD",help="Load a database into postgres"),
):
